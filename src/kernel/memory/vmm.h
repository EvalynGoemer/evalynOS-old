...
#define PTE_LOCKED    0x200 // OS spesific; Do not touch this entry;
...
[[clang::overloadable]] extern void vmm_map_page(pagemap_t *pagemap, uintptr_t virt_addr, uintptr_t phys_addr, uint64_t flags);
