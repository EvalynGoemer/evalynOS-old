...
void setup_idt() {
    ...
    set_idt_entry(INTERRUPT_HANDLER_DEBUG_TRAP, 3, 0x8E, (void (*)())isr0x01);
    set_idt_entry(INTERRUPT_HANDLER_BREAKPOINT_TRAP, 3, 0x8E, (void (*)())isr0x03);
    ...
    set_idt_entry(INTERRUPT_HANDLER_APIC_TIMER, 0, 0x8E, (void (*)())isr0x20);
    set_idt_entry(INTERRUPT_HANDLER_PS2, 0, 0x8E, (void (*)())isr0x21);
    set_idt_entry(INTERRUPT_HANDLER_PS2_MOUSE, 0, 0x8E, (void (*)())isr0x21);
    ...
    set_idt_entry(INTERRUPT_HANDLER_HIGH_PRIORITY_SERIAL, 0, 0x8E, (void (*)())isr0xF0);
